...
import com.dhb.entity.ProxyHostNameVerifier;
import com.dhb.entity.TrustAllCertManager;
   ...
   public static HttpResponser post(HttpRequestParam requestParam){
  	...
  	try {
  		...
  		*/}else{
  		...
  		conn.connect();
  		String content =requestParam.getContext();
  		if(content!=null){	
   ...
   public static HttpResponser postByHttpClient(HttpRequestParam requestParam){
      ...
      try {
    	  ...
    	  */}
          ...
          HttpEntity entity = new StringEntity(requestParam.getContext(),Charset.forName(requestParam.getEncoding()));
