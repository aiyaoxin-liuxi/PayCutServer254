...
var JqueryDialog = {
	...
	init:function(dialogTitle, iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag){
		...
		/* 修改取滚动条滚动高度的代码，2014年10月27日 22:51 李真河 ，原因是此种取滚动条高度的代码在chrome下不兼容   */
//		_jd_dialog.css("top", (_top < 0 ? 0 : _top) + document.documentElement.scrollTop + "px");
		//修改为
		_jd_dialog.css("top", (_top < 0 ? 0 : _top) + (document.documentElement.scrollTop+document.body.scrollTop) + "px");
		/* -- 修改取滚动条滚动高度的代码 结束 */
