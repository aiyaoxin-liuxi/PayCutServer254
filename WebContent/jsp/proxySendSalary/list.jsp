...
<script type="text/javascript" src="<%=basePath %>common/My97DatePicker/WdatePicker.js"></script>
		...
		function upload(){
			...
			javascript:JqueryDialog.Open('','<%=basePath%>proxySendSalary/uploadExcelFile?channelId='+channelId+'&channelName='+channelName+'&merchId='+merchId,900,500);
		}
	</script>
</head>
		...
		<table border="1" class="Table_N" cellspacing="0" cellpadding="5"
			...
			<c:forEach items="${form.pager.datas}" var="proxyPayBatch" varStatus="i">
				...
				<tr class="${rowClass }">
					...
					<td>
						<a href="proxySendSalary/detail?bath_no=${proxyPayBatch.batchId}">
					                  明细
					   </a>
					</td>
					</tr>
